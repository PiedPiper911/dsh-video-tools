...
export async function writeInput(ffmpeg, file, name) {
    await ffmpeg.writeFile(name, await fetchFile(file));
}
/** Read an output file back out of FFmpeg's FS as a Uint8Array. */
export async function readOutput(ffmpeg, name) {
...
export async function cleanup(ffmpeg, names) {
...
export function safeOutName(base, ext) {
